...
# ./train.sh -d bungeenerf/barcelona -l ${exp_name}  --lod 30 --gpu -1 --voxel_size ${voxel_size} --update_init_factor ${update_init_factor} --appearance_dim ${appearance_dim} --ratio ${ratio} &  
# sleep 20s
...
# ./train.sh -d bungeenerf/chicagoo -l ${exp_name}  --lod 30 --gpu -1 --voxel_size ${voxel_size} --update_init_factor ${update_init_factor} --appearance_dim ${appearance_dim} --ratio ${ratio} &  
# sleep 20s
...
# ./train.sh -d Mill19/building -l ${exp_name}  --lod 30 --gpu -1 --voxel_size ${voxel_size} --update_init_factor ${update_init_factor} --appearance_dim ${appearance_dim} --ratio ${ratio}&  
# sleep 20s 